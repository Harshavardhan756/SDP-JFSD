...
<body>
			...
			<div class="carousel-inner">
				...
				<div class="item active">
					...
					<div class="carousel-caption">
						...
						<h1 class="str">
							<b>Best Car Services In Your Location</b>
						</h1>
					</div>
				</div>
				<div class="item">
					...
					<div class="carousel-caption">
						...
						<h1 class="str">
							<b>Quality Cars With Unlimited Miles</b>
						</h1>
					</div>
				</div>
	...
	<div class="container-fluid py-5">
		<div class="container pt-5 pb-3">
			...
			<h1 class="display-4 text-uppercase text-center mb-5 mobile-heading">
				Welcome To <span class="text-primary">AUTOMOBILE SERVICES</span>
			</h1>
